...
chapter: "Academics"
page_bg: academics
subtitle: "All courses Honors or AP level · cybersecurity and engineering focus · Sec+ in progress"
permalink: /academics/
---
...
<div class="section">
  ...
  <div class="info-grid" style="margin-bottom:2.5rem;border:1px solid var(--border-dark);border-radius:var(--radius);overflow:hidden;">
    ...
    <div class="info-cell"><div class="info-pip"></div><div><div class="info-cell-title">AP English Language and Composition</div><div class="info-cell-sub">Completed sophomore year · Score: 4</div></div></div>
  ...
  <div class="ruled-table" style="--cols:1fr 1fr 1fr;">
    ...
    <div class="ruled-row" style="grid-template-columns:1fr 1fr 1fr;"><span class="ruled-name">Python</span><span class="ruled-meta">Algorithms, scripting, distributed computing</span><span class="ruled-badge">Advanced</span></div>
    ...
    <div class="ruled-row" style="grid-template-columns:1fr 1fr 1fr;"><span class="ruled-name">HTML · CSS · JS</span><span class="ruled-meta">Web projects, this site</span><span class="ruled-badge">Intermediate</span></div>
    <div class="ruled-row" style="grid-template-columns:1fr 1fr 1fr;"><span class="ruled-name">Linux · Networking</span><span class="ruled-meta">CTF, cluster setup, server config</span><span class="ruled-badge">Foundational</span></div>
    <div class="ruled-row" style="grid-template-columns:1fr 1fr 1fr;"><span class="ruled-name">CompTIA Sec+</span><span class="ruled-meta">Cybersecurity certification · exam July 2026</span><span class="ruled-badge">In progress</span></div>
